    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img 
                ...
                alt="Thumbnail"
            />
            <div className="opacity-0 absolute top-0 transition duration-100 z-10 invisible sm:visible delay-100 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
                <img 
                    className="
                        cursor-pointer
                        object-cover
                ...
                <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
                    <div className="flex flex-row items-center gap-3">  
                        <div className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white rounded-full flex justify-center items-center transition hover:bg-neutral-300" onClick={() => {}}>
                            <BsFillPlayFill className="text-neutral-700" size={30} onClick={() => router.push(`/watch/${data?.id}`)}  />
                        </div>
                        ...
                        <BiChevronDown className='text-white group-hover/item:text-neutral-300 transition' size={30}  />
                    </div>
                    </div>
